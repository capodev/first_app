...
for ciudad in temperaturas:
    # print("ciudad", temperaturas.index(ciudad)+1)
    for semana in ciudad:
        suma = 0
        for dia in semana:
            suma += dia['temp']
            promedio = suma / 7
        print("promedio de la cuidad ", temperaturas.index(ciudad)+1,
              "de la semana ", ciudad.index(semana)+1, "es: ", round(promedio, 2), "°F")
